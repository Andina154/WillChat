package com.android.willchat.Entities;
...
public class Message implements Serializable{
	...
	public void saveByteArrayToFile(Context context){
		...
		if(x.exists()){
			new File(filePath+"/willChat").mkdirs();
		}

		Log.v(TAG, "Save byte array to file");
		switch(mType){
			case Message.AUDIO_MESSAGE:
				//filePath = context.getExternalFilesDir(x.toString())+"/"+fileName;
				filePath = Environment.getExternalStorageDirectory().toString()+"/willChat/"+fileName;
				break;
